...
class DataPermissionAspect(
    ...
    @Pointcut("@within(com.rhineai.framework.annotation.datapermission.DataPermission) || @annotation(com.rhineai.framework.annotation.datapermission.DataPermission)")
